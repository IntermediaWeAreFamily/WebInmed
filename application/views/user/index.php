                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-sm-6">
                                <div class="block wow fadeInRight" data-wow-delay=".3s" data-wow-duration="500ms">
                                    <img src="<?php echo base_url()?>assets/user/images/team.jpg" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col-md-10">
                                <div class="row">
                                    <div class=" col-md-2 col-sm-2 col-xs-4">
                                        ...
                                        <img src="<?php echo base_url()?>assets/user/img/avatar.jpg" alt="Rounded Image" class="rounded-circle img-raised" >
                                    </div>
                                    <div class=" col-md-2 col-sm-2 col-xs-4">
                                        <p class="category" style="color: #FFFFFF">WAKIL</p>
                                        <img src="<?php echo base_url()?>assets/user/img/avatar.jpg" alt="Circle Image" class="rounded-circle img-raised" >
                                    </div>
                                    <div class=" col-md-2 col-sm-2 col-xs-4">
                                        <p class="category" style="color: #FFFFFF">SEKERTARIS</p>
                                        <img src="<?php echo base_url()?>assets/user/img/avatar.jpg" alt="Raised Image" class="rounded-circle img-raised"  >
                                    </div>
                                    <div class=" col-md-2 col-sm-2 col-xs-4">
                                        <p class="category" style="color: #FFFFFF">BENDAHARA</p>
                                        <img src="<?php echo base_url()?>assets/user/img/avatar.jpg" alt="Thumbnail Image" class="rounded-circle img-raised">
                                    </div>
                                    <div class=" col-md-2 col-sm-2 col-xs-4">
                                        <p class="category" style="color: #FFFFFF">SEKERTARIS</p>
                                        <img src="<?php echo base_url()?>assets/user/img/avatar.jpg" alt="Raised Image" class="rounded-circle img-raised"  >
